...
<x-app-layout>
    ...
    <x-slot name="script">
        ...
        <script type="text/javascript">
            ...
            $('#all-category-table').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blockcategory/" + id);
                    }
                });
            });


            $('#all-category-table').on('change', '.toggle-checkbox', function() {
                var id = $(this).data('id');
                var status = $(this).is(':checked') ? 1 : 0;

                window.location.replace("update-checkbox-status/" + id);
