@section('title', 'Food - Home Content')
<x-app-layout>
    <x-slot name="header">
    ...
    <div id="main" role="main">
        ...
        <div id="content">
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                <header>
                    <h2>{{ __('Food - Home Content') }}</h2>
                </header>
                <div>
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-food-home') }}" enctype="multipart/form-data" method="post" id="food-home-form" class="smart-form">
                            @csrf
                            @method('PUT')
                            <fieldset>
                                <div class="row">
                                ...
                                <div class="row">
                                    <section class="col col-2">
                                        <label class="label">{{ __('Slider Image 1') }} (800 x 1000) </label>
                                        <label class="input">
                                    ...
                                    <section class="col col-2">
                                        <label class="label">{{ __('Slider Image 2') }} (800 x 1000) </label>
                                        <label class="input">
                                    ...
                                    <section class="col col-2">
                                        <label class="label">{{ __('Slider Image 3') }} (800 x 1000) </label>
                                        <label class="input">
                                    ...
                                    <section class="col col-2">
                                        <label class="label">{{ __('Slider Image 4') }} (800 x 1000) </label>
                                        <label class="input">
                                            <input type="file" class="form-control form-input" id="image4" name="image4" style="overflow: hidden;" >
                                        </label>
                                    </section>
                                    <section class="col col-2">
                                        <img id="preview-image4" src="storage/app/{{ $data->image4 }}" alt="preview image" style="max-height: 250px;">
                                    </section>

                                    <section class="col col-2">
                                        <label class="label">{{ __('Slider Image 5') }} (800 x 1000) </label>
                                        <label class="input">
                                            <input type="file" class="form-control form-input" id="image5" name="image5" style="overflow: hidden;" >
                                        </label>
                                    </section>
                                    <section class="col col-2">
                                        <img id="preview-image5" src="storage/app/{{ $data->image5 }}" alt="preview image" style="max-height: 250px;">
                                    </section>

                                    <section class="col col-2">
                                        <label class="label">{{ __('Slider Image 6') }} (800 x 1000) </label>
                                        <label class="input">
                                            <input type="file" class="form-control form-input" id="image6" name="image6" style="overflow: hidden;" >
                                        </label>
                                    </section>
                                    <section class="col col-2">
                                        <img id="preview-image6" src="storage/app/{{ $data->image6 }}" alt="preview image" style="max-height: 250px;">
                                    </section>
                                </div>
                            </fieldset>
                            <footer>
