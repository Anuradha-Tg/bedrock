                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <section class="col col-2">
                                            <img id="preview-image-before-upload-desktop" src="{{ asset('public/back/img/whitebg.jpg'); }}" alt="preview image" style="max-height: 250px;">
                                        </section>
                                        ...
                                        <section class="col col-2">
                                            <img id="preview-image-before-upload-mobile" src="{{ asset('public/back/img/whitebg.jpg'); }}" alt="preview image" style="max-height: 250px;">
                                        </section>
                                    </div>
