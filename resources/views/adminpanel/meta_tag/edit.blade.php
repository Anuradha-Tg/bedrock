                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <section class="col col-12"  style="width: 100%;">
                                        ...
                                        <label class="input">
                                            <input type="text" id="og_type" name="og_type" value="{{ $data->og_type }}" required>
                                        </label>
                                    </section>
                                </div>
                                <div class="row">
                                    <section class="col col-12"  style="width: 100%;">
                                        ...
                                        <label class="input">
                                            <input type="text" id="og_tag" name="og_tag" value="{{ $data->og_tag }}" required>
                                        </label>
                                    </section>
                                </div>
                                <div class="row">
                                    <section class="col col-12"  style="width: 100%;">
                                        ...
                                        <label class="input">
                                            <input type="text" id="og_url" name="og_url" value="{{ $data->og_url }}" required>
                                        </label>
                                    </section>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <section class="col col-12"  style="width: 100%;">
                                        ...
                                        <label class="input">
                                            <input type="text" id="og_sitename" name="og_sitename" value="{{ $data->og_sitename }}" required>
                                        </label>
                                    </section>
                                </div>
                                <div class="row">
