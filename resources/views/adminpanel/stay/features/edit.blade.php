            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-room-feature') }}" enctype="multipart/form-data" method="post" id="room-feature-form" class="smart-form">
                        @csrf
                        @method('PUT')
                            <fieldset>
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <section class="col col-2">
                                            <label class="label">{{ __('Icon') }} (1920 x 1080) <span style=" color: red;">*</span></label>
                                            <label class="input">
                                                <input type="file" class="form-control form-input" id="icon" name="icon" style="overflow: hidden;" >
                                            </label>
                                        </section>
                                        <section class="col col-2">
                                            <img id="preview-image-before-upload-icon" src="../storage/app/{{ $data->icon }}" alt="preview image" style="max-height: 250px;">
                                        </section>
