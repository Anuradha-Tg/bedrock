            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('new-room-feature') }}" enctype="multipart/form-data" method="post" id="room-feature-form" class="smart-form">
                            @csrf
                            <fieldset>
                                <div class="row">
                                    ...
                                    <section class="col col-2">
                                        ...
                                        <section class="col col-2">
                                            <img id="preview-image-before-upload-icon" src="{{ asset('public/back/img/whitebg.jpg'); }}" alt="preview image" style="max-height: 250px;">
                                        </section>
