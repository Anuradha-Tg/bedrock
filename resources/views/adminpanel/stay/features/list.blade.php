...
<x-app-layout>
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types" data-widget-editbutton="false">
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" width="100%" id="room-feature-table">
                                        <thead>
                                            <tr>
                                                <th>{{ __('No') }}</th>
                                                <th >{{ __('Title') }}</th>
                                                <th width="150px">{{ __('Icon') }}</th>
    ...
    <x-slot name="script">
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: 'room_features_images',
                            name: 'room_features_images'
                        },
                        {
                            data: 'order',
                            name: 'order'
            ...
            $('#room-feature-table').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blockfeature/" + id);
                    }
                });
            });
        </script>
