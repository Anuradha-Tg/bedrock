...
<x-guest-layout>
    <div id="main" role="main">
        ...
        <div class="hero login_heading" style="background-image: none;">
            <h1 class="main_heading">Bedrock Hotel Kalpitiya</h1>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-5 col-lg-4 login_form_div">
                    ...
                    <div class="well no-padding" style="box-shadow: none; background-color: transparent;">
                        ...
                        <img src="{{ asset('public/frontend/images/logo.jpg') }}" alt="" class="img-responsive labor_logo center-block" style="padding-left: 15px; padding-right: 15px; margin-bottom: 15px; height:150px;">
