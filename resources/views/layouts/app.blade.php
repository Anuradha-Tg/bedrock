...
<head>
    ...
    <title>Bedrock Hotel Kalpitiya | @yield('title')</title>
    ...
    <link rel="stylesheet" type="text/css" media="screen"
        href="{{ asset('public/back/css/smartadmin-production-plugins.min.css') }}">
    <link rel="stylesheet" type="text/css" media="screen"
        href="{{ asset('public/back/css/smartadmin-production.min.css') }}">
    <link rel="stylesheet" type="text/css" media="screen"
        href="{{ asset('public/back/css/smartadmin-skins.min.css') }}">
    ...
    @if (Session()->get('applocale') == 'ta')
        <!--media query css-->
        <link href="{{ asset('public/back/css/mediaquery_tamil.css') }}" rel="stylesheet" type="text/css"
            media="screen">
        <!--media query css-->
    @elseif (Session()->get('applocale') == 'si')
        <!--media query css-->
        <link href="{{ asset('public/back/css/mediaquery_sinhala.css') }}" rel="stylesheet" type="text/css"
            media="screen">
        <!--media query css-->
    @else
        <!--media query css-->
  ...
  <link rel="stylesheet" type="text/css" media="screen" href="css/your_style.css') }}" -->
   ...
   Ref: https://developer.apple.com/library/ios/documentation/AppleApplications/Reference/SafariWebContent/ConfiguringWebApplications/ConfiguringWebApplications.html -->
    ...
    <link rel="apple-touch-icon" sizes="120x120"
        href="{{ asset('public/back/img/splash/touch-icon-iphone-retina.png') }}">
    <link rel="apple-touch-icon" sizes="152x152"
        href="{{ asset('public/back/img/splash/touch-icon-ipad-retina.png') }}">
...
<body class="">
    ...
    <div class="page-footer">
        <div class="row">
            <div class="col-xs-12 col-sm-6">
                ...
                <span class="txt-color-white">© {{ date('Y') }} | <small>Solution by - <a
                            href="https://www.tekgeeks.net/" target="_blank"
                            style="color: #999999;">TekGeeks</a></small></span>
  ...
  -->
    ...
    <script data-pace-options='{ "restartOnRequestAfter": true }'
        src="{{ asset('public/back/js/plugin/pace/pace.min.js') }}"></script>

    <!-- Link to Google CDN's jQuery + jQueryUI; fall back to local -->

    <!-- <script>
        if (!window.jQuery) {
            document.write('<script src="{{ asset('public/back/js/libs/jquery-3.7.1.min.js') }}">
    </script>');
  }
 </script>
 ...
 <script>
     if (!window.jQuery.ui) {
         document.write('<script src="{{ asset('public/back/js/libs/jquery-ui.min.js') }}">
 </script>');
  }
 </script> -->
  ...
  <![endif]-->
    ...
    <script src="{{ asset('public/back/js/libs/sweetalert.min.js') }}"></script>
